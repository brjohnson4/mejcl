            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">Olympika Individual Results</div>
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'olympika-input-individual')) !!}
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">Olympika School Results</div>
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'olympika-input-school')) !!}
